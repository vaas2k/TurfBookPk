      ...
      <SafeAreaView className="flex-1 bg-[#F8F9FA]">
        ...
        <View className="flex-1 items-center justify-center px-6">
          ...
          <Text className="text-[#737373] text-center mt-3 text-sm leading-5">
            Verifying transaction status securely. Please do not close or minimize the app.
          </Text>
          <Text className="text-[#737373] text-center mt-4 text-xs">
        ...
        <View className="flex-1 px-6">
          <View className="flex-1 items-center justify-center">
            ...
            <View className="w-full bg-white rounded-2xl p-6 mt-8"
              ...
              <Text className="text-[#1A1A2E] text-sm font-semibold mb-2">ERROR REASON</Text>
              <Text className="text-[#737373] text-sm leading-5">
                Transaction Timed Out — The payment request was not approved within the required 10-minute window.
              </Text>
            </View>

            <View className="w-full bg-[#F5F5F5] rounded-xl p-4 mt-4">
              <Text className="text-[#737373] text-sm text-center">
                Your selected slot at <Text className="text-[#1A1A2E] font-medium">Green Valley</Text> remains available for 5 minutes.
              </Text>
            </View>
          </View>
          ...
          <View className="pb-8 space-y-3">
            ...
            >
              <Text className="text-[#1A1A2E] text-center font-medium">Choose Different Method</Text>
            </TouchableOpacity>

            <TouchableOpacity className="py-2">
              <Text className="text-[#4CAF50] text-center font-medium">Contact Support {'>'}</Text>
            </TouchableOpacity>
          </View>
        </View>
      </SafeAreaView>
  ...
  return (
    <SafeAreaView className="flex-1 bg-[#F8F9FA]">
      ...
      <View className="flex-1 items-center justify-center px-6">
        ...
        <Text className="text-[#4CAF50] text-center mt-4 font-bold text-2xl">{timer}s</Text>
      </View>
    </SafeAreaView>
  );
}